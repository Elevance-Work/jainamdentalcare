                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6 mb-24">
                        <select name="select-date" className="nice-select wide vl-select-date">
                          <option data-display="Date">Monday - Friday(9AM - 8:30PM)</option>
                          <option value={1}>Sunday(As Per Appointment)</option>
                          <option value={2}>Saturday(9AM - 8:30PM)</option>
                        </select>
                      </div>
                ...
                <div className="vl-contact-info-box">
                  <div className="vl-single-info-box">
                    <div className="vl-contact-info-box-flex">
                      ...
                      <span className="time">9AM - 8:30PM</span>
                    </div>
                  </div>
                  <div className="vl-single-info-box">
                    <div className="vl-contact-info-box-flex">
                      <h4 className="title">Sunday</h4>
                      <span className="time">As Per Appointment</span>
                    </div>
                  </div>
                  <div className="vl-single-info-box">
                    <div className="vl-contact-info-box-flex">
